...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    // クライアントサイドバリデーション
    const validationResults = validateLoginForm(email, password);
          ...
          <form className="space-y-5" onSubmit={handleEmailLogin}>
            ...
            <div className="text-center pt-3">
              <p className="text-sm sm:text-base text-gray-600">
                アカウントをお持ちでない方は{' '}
                <Link href="/signup" className="font-semibold text-rose-500 hover:text-rose-600 transition-colors duration-300 text-base">
                  新規登録
                </Link>
              </p>
            </div>
